...
class Hangman:
    ...
    # tạo hàm để tạo ra các khoảng trống tương ứng độ dài từ
    def space(self):
...
# CỬA SỔ KẾT THÚC
def end_game():
    with dpg.window(tag="End game", width=660, height=800, no_resize=True, no_collapse=True,
